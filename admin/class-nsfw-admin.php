...
class Nsfw_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/nsfw-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/nsfw-admin.js', array( 'jquery' ), $this->version, false );

	}

	/**
	 * Add PNSFW field to media uploader
	 *
	...
	public function attachment_field_nsfw( $form_fields, $post ) {
	    ...
	    $form_fields['nsfw'] = array(
	        ...
	        'value' => 1,
	        'helps' => __('Add to the NSFW list', 'nsfw'),
	    );
